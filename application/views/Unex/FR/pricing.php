...
<div class="page-wrapper">
                        ...
                        <nav class="main-menu navbar-expand-md">
                            ...
                            <div class="navbar-collapse collapse scroll-nav clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current"><a href="<?php echo base_url(); ?>FR/Unex/pricing">Tarifs</a></li>
                                    <li><a href="<?php echo base_url(); ?>FR/Unex/blog">Blog</a></li>
                                    <li class="dropdown"><a href="#">Langues</a>
                                        <ul>
                                            <li><a href="<?php echo base_url(); ?>EN/Unex/pricing">EN</a></li>
                                            <li><a href="<?php echo base_url(); ?>FR/Unex/pricing">FR</a></li>
                                        </ul>
                                    </li>
    ...
    <section class="sponsor-section">
        <span class="float-text">Tarifs</span>
            ...
            <div class="row">
                ...
                <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        ...
                        <ul class="features">
                            <li><i><b>Abonnement :</b></i> 5€/mois</li>
                            <li><i><b>Achat unique :</b></i> 2000€</li>
                            <li><i><b>Achat journalier :</b></i> 5000€</li>
                            <li><i><b>Retrait unique</b></i> : 
                                <ul>
                                    <li>100€ pour les Africains</li>
                                    <li>1000€ pour les autres pays</li>
                                </ul>
                            </li>
                            <li><i><b>Retrait journalier :</b></i> 1000€</li>
                        </ul>
                        <!--<div class="btn-box">
                ...
                <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInDown">
                    <div class="inner-box">
                        ...
                        <ul class="features">
                            <li><i><b>Abonnement :</b></i> 7€/mois</li>
                            <li><i><b>Achat unique :</b></i> 10000€</li>
                            <li><i><b>Achat journalier :</b></i> 50000€</li>
                            <li><i><b>Retrait unique</b></i> : 
                                <ul>
                                    <li>100€ pour les Africains</li>
                                    <li>1000€ pour les autres pays</li>
                            ...
                            <li><i><b>Retrait journalier :</b></i> 2000€</li>
                        </ul>
                        <!--<div class="btn-box">
                            <a href="contact.php" class="theme-btn">Get it</a>
                        </div>-->
                ...
                <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        ...
                        <ul class="features">
                            <li><i><b>Abonnement :</b></i> 10€/mois</li>
                            <li><i><b>Achat unique :</b></i> 50000€</li>
                            <li><i><b>Achat journalier :</b></i> 100000€</li>
                            <li><i><b>Retrait unique</b></i> : 
                                <ul>
                                    <li>100€ pour les Africains</li>
                                    <li>1000€ pour les autres pays</li>
                            ...
                            <li><i><b>Retrait journalier :</b></i> 3000€</li>
                        </ul>
                        <!--<div class="btn-box">
                            <a href="contact.php" class="theme-btn">Get it</a>
                        </div>-->
