...
<div class="page-wrapper">
                ...
                <div class="clearfix">
                    ...
                    <div class="nav-outer clearfix">
                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown current"><a href="#">Services</a>
                                        <ul>
                                            ...
                                            <!-- <li><a href="<?php //echo base_url(); ?>EN/Unex/card#our_card">Cartes</a></li> -->
                                        </ul>
                                    </li>
                        ...
                        <div class="btn-box">
                            ...
                            <a href="https://client.unex.online" class="theme-btn btn-style-one"><span class="fa fa-sign-in"></span> Sign in</a>
                        </div>
    ...
    <section class="about-section">
        ...
        <span class="float-text">Unex cards</span>
            ...
            <div class="about-carousel owl-carousel owl-theme">
                ...
                <div class="slide-item clearfix">
                    ...
                    <div class="content-box">
                        <h3>Black card</h3>
                        <div class="inner-box">
                            <div class="text">Standard card from Unex for everyone.</div>
                        </div> 
                        <div><br><br><br></div>
                    </div>
                </div>
                ...
                <div class="slide-item clearfix">
                    ...
                    <div class="content-box">
                        <div class="inner-box"> 
                            <h3>Gold card</h3>
                            <div class="text">This card is used by employees.</div>
                        </div> 
                            <div><br><br><br></div>
                    </div>
                </div>
                ...
                <div class="slide-item clearfix">
                    ...
                    <div class="content-box">
                        <h3>Platinum card</h3>
                        <div class="inner-box">
                            <div class="text">This is exclusively for companies.</div>
                        </div> 
                        <div><br><br><br></div>
                    </div>
                </div>
        ...
        <div class="sec-title container" id="description_cards">
                <h5>  The UNEX debit card is attached to your wallet and will serve both as a means of cash withdrawal at the ATM but also as a means of payment on merchant sites accepting VISA, Mastercard, UnionPay ... UNEX cards have the 3D secure option.
The card limits, the monthly subscription as well as the fees vary according to the ranges offered by UNEX</h5>
            </div>
    </section>
    <!--End About Section -->
