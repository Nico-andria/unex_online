...
<body>
                            ...
                            <div class="navbar-collapse collapse scroll-nav clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">Langues</a>
                                        <ul>
                                            <li><a href="<?php echo base_url(); ?>EN/Unex/tuto">EN</a></li>
                                            <li><a href="<?php echo base_url(); ?>FR/Unex/tuto">FR</a></li>
                                        </ul>
                                    </li>
   ...
   <!-- Vidéos tutos -->
    <div class="container-fluid sponsor-section">
        <span class="float-text">Tutoriels</span>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="pricing-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                    ...
                    <div class="price" style="color: white;">
                        <h2 style="padding-bottom: 10px;" align="center">Débuter</h2>
                ...
                <div class="pricing-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                    ...
                    <div class="price" style="color: white;">
                        <h2 style="padding-bottom: 10px;" align="center">Manipulation</h2>
                        <div style="padding-right: 20px;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="pricing-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="400ms" style="padding: 20px;">
                    <a href="<?php echo base_url(); ?>assets/docs/guide/Inscription.pdf" target="_blank" style="color: white;">Comment faire son inscription ?</a>
                </div> 
                <div class="pricing-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="600ms" style="padding: 20px;">
                    <a href="<?php echo base_url(); ?>assets/docs/guide/Depot.pdf" target="_blank" style="color: white;">Comment déposer de l'argent sur son compte UNEX ?</a>
                </div> 
                <div class="pricing-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="800ms" style="padding: 20px;">
                    <a href="<?php echo base_url(); ?>assets/docs/guide/numero_compte.pdf" target="_blank" style="color: white;">Comment savoir son numéro de compte UNEX ?</a>
                </div> 
                <div class="pricing-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="400ms" style="padding: 20px;">
                    <a href="<?php echo base_url(); ?>assets/docs/guide/retrait.pdf" target="_blank" style="color: white;">Comment faire le retrait de vos fonds ?</a>
                </div> 
                <div class="pricing-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="600ms" style="padding: 20px;">
                    <a href="<?php echo base_url(); ?>assets/docs/guide/conversion_devises.pdf" target="_blank" style="color: white;">Comment convertir les devises dans son compte ?</a>
                </div> 
                <div class="pricing-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="800ms" style="padding: 20px;">
                    <a href="<?php echo base_url(); ?>assets/docs/guide/demande_de_paiement.pdf" target="_blank" style="color: white;">Comment demander des soldes à un autre utilisateur ?</a>
                </div> 
                <div class="pricing-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="400ms" style="padding: 20px;">
                    <a href="<?php echo base_url(); ?>assets/docs/guide/recevoir.pdf" target="_blank" style="color: white;">Comment recevoir de l'argent depuis un autre compte ?</a>
                </div> 
                <div class="pricing-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="400ms" style="padding: 20px;">
                    <a href="<?php echo base_url(); ?>assets/docs/guide/transfert.pdf" target="_blank" style="color: white;">Comment transférer vos soldes vers un autre utilisateur ?</a>
                </div>                
            </div>
        </div>
    </div>
